...
import { Printer, Usb, Bluetooth, X } from "lucide-react";
          ...
          {connection ? (
            ...
            <>
              <button
                ...
                className="flex w-full items-center gap-2.5 rounded-lg px-3 py-2 text-left text-sm font-medium transition-colors hover:bg-emerald-50 hover:text-emerald-700 disabled:opacity-40"
              >
